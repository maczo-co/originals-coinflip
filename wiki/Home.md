# maczo Originals — Coin Flip · Provably Fair

Welcome. This wiki explains how every **Coin Flip** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Coin Flip's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=coinflip
- **Source / Node CLI:** https://github.com/maczo-co/originals-coinflip
- **Published odds:** https://verify.maczo.co/originals/paytables/coinflip.json
